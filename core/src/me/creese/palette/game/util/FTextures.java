...
public class FTextures {
    ...
    public static final int CIRCLE_PALETTE      = 1003;
    public static final int SMALL_ARC_PALETTE   = 1004;
    public static final int SCORE_BACK          = 1005;
    ...
    public static final int DOUBLE_TAP_ICON     = 1013;
    public static final int HOLD_ICON           = 1014;
    public static final int BOMB_ICON           = 1015;
    public static final int CIRCLE_BONUS        = 1016;
    public static final int CIRCLE_BONUS_SHADOW = 1017;
}
